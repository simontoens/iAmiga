...
//  iUAE
//
//  Created by Urs on 29.09.16.
//
//

#ifndef constSettings_h
#define constSettings_h
...
static NSString *const kKeyButtonsEnabledKey = @"_keyButtonsEnabled";
static NSString *const kKeyButtonConfigurationsKey = @"_keyButtonConfigurations";
...
static NSString *const kRomPath = @"_romPath";
...
static NSString *const kCmem = @"_cmem";
static NSString *const kFmem = @"_fmem";
