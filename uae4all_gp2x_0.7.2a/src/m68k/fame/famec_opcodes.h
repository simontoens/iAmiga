...
OPCODE(0x027C)
{
	...
	if (!flag_S)
#ifdef OPCODES_M68000
        EXECUTE_EXCEPTION(M68K_PRIVILEGE_VIOLATION_EX,(int) 20)
#else
        EXECUTE_EXCEPTION(M68K_PRIVILEGE_VIOLATION_EX, (int) 12)
#endif
...
OPCODE(0x0C3A)
{
    ...
    FETCH_BYTE(src);
    adr = (int) (GET_SWORD + ((uintptr_t)(PC) - BasePC));
    PC++;
    READ_BYTE_F(adr, dst)
    res = dst - src;
    flag_N = flag_C = res;
...
OPCODE(0x46C0)
{
    ...
    if (!flag_S)
        ...
        EXECUTE_EXCEPTION(M68K_PRIVILEGE_VIOLATION_EX,(int) 12)
#else
        EXECUTE_EXCEPTION(M68K_PRIVILEGE_VIOLATION_EX, (int) 8)
#endif
